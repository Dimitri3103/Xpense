...
export default function NavbarSupervisor() {
  ...
  const renderMenu = (
    ...
    >
      <MenuItemCRuD onClick={() => handleClick("/supervisor/profile")}>
        <IconButton
    ...
    >
      ...
      <MenuItemCRuD onClick={() => handleClick("/supervisor/profile")}>
        <IconButton
          ...
          size="small"
        >
          <i className="uil uil-user-square" style={{ color: "#9BABC5" }} />
        </IconButton>
        Profil
      </MenuItemCRuD>
      <MenuItemCRuD onClick={() => handleClick("/supervisor/notifications")}>
        <IconButton
      ...
      <Grid container>
        <Grid item xs={12} style={{ textAlign: "center" }}>
          <Button
            ...
            onClick={() => handleClick("/supervisor/notifications")}
          >
            Voir plus
          </Button>
        </Grid>
  ...
  return (
    <div className={classes.grow}>
      <AppBar className={classes.appBar}>
        <Toolbar>
          <a href="/supervisor" className={classes.title}>
            Xpense
          </a>
